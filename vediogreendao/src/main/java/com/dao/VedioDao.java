...
public class VedioDao {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Schema schema = new Schema(dbVersion, "me.itangqi.greendao");
...
//      schema.setDefaultJavaPackageDao("me.itangqi.dao");
        ...
        //C:\sofrware\workspace\VRmc
        new DaoGenerator().generateAll(schema, "C:\\sofrware\\workspace\\VRmc\\app\\src\\main\\java-gen");
    }
